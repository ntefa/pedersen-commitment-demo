...
import (
	"pedersen-commitment-transfer/lib/tests"
	"sync"
...
func (fake *FakeTestChaincodeStubInterface) PurgePrivateData(arg1 string, arg2 string) error {
...
func (fake *FakeTestChaincodeStubInterface) PurgePrivateDataCallCount() int {
	fake.purgePrivateDataMutex.RLock()
	defer fake.purgePrivateDataMutex.RUnlock()
	return len(fake.purgePrivateDataArgsForCall)
}

func (fake *FakeTestChaincodeStubInterface) PurgePrivateDataCalls(stub func(string, string) error) {
	fake.purgePrivateDataMutex.Lock()
	defer fake.purgePrivateDataMutex.Unlock()
	fake.PurgePrivateDataStub = stub
}

func (fake *FakeTestChaincodeStubInterface) PurgePrivateDataArgsForCall(i int) (string, string) {
	fake.purgePrivateDataMutex.RLock()
	defer fake.purgePrivateDataMutex.RUnlock()
...
func (fake *FakeTestChaincodeStubInterface) PurgePrivateDataReturns(result1 error) {
	fake.purgePrivateDataMutex.Lock()
	defer fake.purgePrivateDataMutex.Unlock()
...
func (fake *FakeTestChaincodeStubInterface) PurgePrivateDataReturnsOnCall(i int, result1 error) {
	fake.purgePrivateDataMutex.Lock()
	defer fake.purgePrivateDataMutex.Unlock()
	fake.PurgePrivateDataStub = nil
